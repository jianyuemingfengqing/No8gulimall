...
CREATE TABLE `wms_ware_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='商品库存';

-- ----------------------------
-- Records of wms_ware_sku
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES ('1', '30', '3', '193', '华为mate30pro 黑色,8G,128G', '100', '17');
INSERT INTO `wms_ware_sku` VALUES ('2', '30', '2', '200', '华为mate30pro 黑色,8G,128G', '100', '20');
INSERT INTO `wms_ware_sku` VALUES ('3', '31', '1', '100', '尚硅谷G1000手机 金色,12G,256G', '100', '0');
INSERT INTO `wms_ware_sku` VALUES ('4', '31', '2', '997', '尚硅谷G1000手机 金色,12G,256G', '100', '103');
