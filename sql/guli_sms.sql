...
Source Database       : guli_sms

Target Server Type    : MYSQL
Target Server Version : 50716
File Encoding         : 65001

Date: 2020-07-12 09:57:58
*/
...
CREATE TABLE `sms_seckill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀活动场次';
...
CREATE TABLE `sms_seckill_sku` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀活动商品关联';
...
-- ----------------------------
INSERT INTO `sms_sku_bounds` VALUES ('1', '5', '2000.0000', '1000.0000', '10');
INSERT INTO `sms_sku_bounds` VALUES ('2', '6', '1000.0000', '2000.0000', '9');
INSERT INTO `sms_sku_bounds` VALUES ('3', '7', '2000.0000', '1000.0000', '10');
INSERT INTO `sms_sku_bounds` VALUES ('4', '8', '1000.0000', '2000.0000', '9');
INSERT INTO `sms_sku_bounds` VALUES ('5', '9', '2000.0000', '1000.0000', '10');
INSERT INTO `sms_sku_bounds` VALUES ('6', '10', '1000.0000', '2000.0000', '9');
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品满减信息';

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES ('1', '5', '5000.0000', '100.0000', '1');
INSERT INTO `sms_sku_full_reduction` VALUES ('2', '6', '6000.0000', '1500.0000', '1');
INSERT INTO `sms_sku_full_reduction` VALUES ('3', '7', '5000.0000', '100.0000', '1');
INSERT INTO `sms_sku_full_reduction` VALUES ('4', '8', '6000.0000', '1500.0000', '1');
INSERT INTO `sms_sku_full_reduction` VALUES ('5', '9', '5000.0000', '100.0000', '1');
INSERT INTO `sms_sku_full_reduction` VALUES ('6', '10', '6000.0000', '1500.0000', '1');
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品阶梯价格';

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES ('1', '5', '2', '9.00', null);
INSERT INTO `sms_sku_ladder` VALUES ('2', '6', '2', '80.00', null);
INSERT INTO `sms_sku_ladder` VALUES ('3', '7', '2', '9.00', null);
